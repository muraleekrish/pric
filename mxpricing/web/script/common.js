...
function showHide(plt) {
	...
	var showImg = path+"images/show.gif";
	var hideImg = path+"images/hide.gif";
...
function showHideSpl1(tableId,anotblId,imgId,dvList){
	var table = document.getElementById(tableId);
	var anotable = document.getElementById(anotblId);
	var img = document.getElementById(imgId);
	...
	if (table.style.display == "none")
	{
		...
		if(anotable.style.display == "none")
			dvl.style.height= "180px";
		else
