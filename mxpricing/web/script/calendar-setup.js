...
// $Id: calendar-setup.js,v 1.1 2005/06/06 10:11:54 ahariharan Exp $

/**
 *  This function "patches" an input field (or other element) to use a calendar
 *  widget for date selection.
 *
 *  Note that you can use the Mira DHTML Calendar Wizard and generate the code
 ...
 */
Mira.Calendar.setup = function (params) {
	...
	if (params.flat != null) {
		...
		var cal = new Mira.Calendar(params.firstDay, params.date, params.onSelect || onSelect);
	...
	triggerEl["on" + params.eventName] = function() {
		...
		if (!(cal && params.cache)) {
			window.calendar = cal = new Mira.Calendar(params.firstDay,
							     params.date,
