...
<jsp:useBean id="frm" class="com.savant.pricing.presentation.pricing.ProspectiveCustomerAddForm" /><jsp:setProperty name="frm" property="*" />
<%try{
...
function customerEdit()
{
	...
	temp.action='<%=request.getContextPath()%>/ProspectiveCustomerMngrcustEdit.do?prsCustId=<%=frm.getProspectiveCustId()%>';
...
{
	var temp = document.forms[0];
	temp.action = '<%=request.getContextPath()%>/jsp/pricing/ProspectiveCustomersRep.jsp';
	temp.submit();
...
<body> 
<html:form action="pRepView"> <html:hidden property="formActions"/> <html:hidden property="prospectiveCustId"/> 
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0" > 
  <tr> 
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
			<tr> 
				<td class="fieldata"> <html:button  property="Cancel" styleClass="button" value="List" onclick="calllist()"></html:button>  
			</tr> 
		</table>
     </td> 
  </tr> 
