...
<%
	...
	String Custids =  objProspectiveCustomerDAO.getAllAutoRunProspectives();
	String[] Cust_ids = Custids.split(",");
		System.out.println("******** Cust_ids:"+Custids);
		System.out.println("******** Cust_ids.length:"+Cust_ids.length);
		System.out.println("******** Auto run ids:"+Custids);
	if(!Custids.equalsIgnoreCase(""))
	{
		for(int s = 0; s <Cust_ids.length;s++ )	
		{
			objProspectiveCustomerVO = objProspectiveCustomerDAO.getProspectiveCustomer(Integer.parseInt(Cust_ids[s]));
			lstProspectiveCust.add(s,objProspectiveCustomerVO);
		}
	}
...
function run()
{
	...
	temp.formActions.value="autorun";
	temp.submit();
  ...
  <tr> 
    <td valign="top"> <jsp:include page="../menu.jsp"/>
  		<table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
      		<tr> 
        		<td width="800" class="page_title">Auto Run 
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" > 
          ...
          <tr> 
            <td colspan="3" align="right" ><input type="button" class="button" name="add" value="Auto Run " onClick="run();showprogress('yes');">
