...
<html:form action="CongestionZoneView">
    ...
    <td  valign="top"><jsp:include page="/jsp/menu.jsp"/>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="fieldata"><%= objCongestionZonesVO.getCongestionZone()%> </td>
          </tr>
          <tr>
            <td valign="top" class="fieldtitle">Description</td>
            <td valign="top" class="fieldtitle">:</td>
            <td class="fieldata"><%= objCongestionZonesVO.getDescription()%></td>
          </tr>
        </table>
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="btnbg"><html:button property="cancel" styleClass="button" value="Back" onclick="callCancel()"></html:button></td>
          </tr>
        </table></td> 
  </tr> 
  <tr> 
