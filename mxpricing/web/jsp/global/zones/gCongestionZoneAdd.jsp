...
<html:form action="CongestionZoneAdd">
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="fieldata"><html:text property="txtCongestionZoneName" size="30" maxlength="40"/></td>
          </tr>
          <tr>
            <td valign="top" class="fieldtitle">Description</td>
            <td valign="top" class="fieldtitle">:</td>
            <td class="fieldata"><html:textarea property="txtaDescription" cols="40" rows="4"/></td>
          </tr>
        </table>
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="btnbg"><html:button property="CongZoneAdd" styleClass="button" onclick="addZone('Add')" value="Add"></html:button>
