 ...
 */
public class HeatRateForm extends ActionForm {
    ...
    private String  heatRateInput ="7900";
    
    public String getHeatRateInput() {
        return heatRateInput;
    }
    public void setHeatRateInput(String heatRateInput) {
        this.heatRateInput = heatRateInput;
    }
